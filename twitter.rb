...
class TwitterPlugin < Plugin
   ...
   Config.register Config::StringValue.new('twitter.secret',
    ...
    Config.register Config::BooleanValue.new('twitter.status_show_replies',
      :default => true,
      :desc => "Show replies in the result of 'twitter status'")
...
plugin.map 'twitter status [reply] [noreply] [:nick]', :action => "get_status", :requirements => { :reply => /^reply$/ }, :threaded => true
